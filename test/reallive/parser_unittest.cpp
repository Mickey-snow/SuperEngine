...
TEST(BytecodeFormattingTest, PrintableToParsableString) {
  {
    ...
    EXPECT_EQ(PrintableToParsableString(src),
              std::string_view(parsable_bytecode, sizeof(parsable_bytecode)))
        << "(4097)";
  }

  {
    ...
    char parsable_bytecode[] = {
        ...
        0xff, 0x00, 0x00, 0x00, 0x00, 0x5d, 0x5c, 0x00, 0x24, 0xff, 0x39,
        0x00, 0x00, 0x00, 0x24, 0x0b, 0x5b, 0x24, 0xff, 0x01, 0x00, 0x00,
        0x00, 0x5d, 0x5c, 0x00, 0x24, 0xff, 0x29, 0x00, 0x00, 0x00, 0x29};
    EXPECT_EQ(PrintableToParsableString(src),
              std::string_view(parsable_bytecode, sizeof(parsable_bytecode)))
